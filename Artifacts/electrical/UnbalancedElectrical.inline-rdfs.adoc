...
Profile namespace: http://www.ucaiug.org/gmdm_unbalanced_electrical#
...
|0..1
|<<UnbalancedElectrical-AsynchronousMachineKind,AsynchronousMachineKind>>
|
...
|0..1
|<<UnbalancedElectrical-EnergySchedulingType,EnergySchedulingType>>
|
...
[[UnbalancedElectrical-SwitchPhase]]
==== (Description) SwitchPhase

Inheritance path = <<UnbalancedElectrical-PowerSystemResource,PowerSystemResource>> => <<UnbalancedElectrical-IdentifiedObject,IdentifiedObject>> => <<UnbalancedElectrical-Identity,Identity>>

ifdef::UnbalancedElectrical-description-profile[]
This class is tagged in this profile with the 'Description' tag. To refer to the full definition of this class as defined in the profile this one depends on visit <<{UnbalancedElectrical-description-profile}-SwitchPhase,SwitchPhase>>.
endif::UnbalancedElectrical-description-profile[]
...
|type (enumeration)
|0..1
|<<UnbalancedElectrical-SynchronousMachineKind,SynchronousMachineKind>>
|
...
[[UnbalancedElectrical-EnergySchedulingType]]
==== EnergySchedulingType
...
[[UnbalancedElectrical-AsynchronousMachineKind]]
...
|===
[[UnbalancedElectrical-PhaseShuntConnectionKind]]
...
|===
[[UnbalancedElectrical-SynchronousMachineKind]]
